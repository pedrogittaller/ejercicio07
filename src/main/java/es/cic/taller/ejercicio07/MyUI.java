...
public class MyUI extends UI {
	...
	protected void init(VaadinRequest vaadinRequest) {
		...
		ComboBox<Pais> cbPais = new ComboBox<>("Selecciona tu país", listaPaises);
		cbPais.setPlaceholder("Ningún país seleccionado");
	...
	private String calcularMensaje(Persona persona) {
		...
		String mensaje = String.format("Hola %s %s, estamos a %s en %s", persona.getNombre(), persona.getApellidos(),
				sFecha, persona.getPais());
		return mensaje;
	}
